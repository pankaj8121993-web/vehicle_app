...
curl -X GET "https://your-app.com/api/vehicles" -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
NOTE: Users in this app have a `role` field: driver | data_entry | fleet_manager | management.
Use role 'management' for full-access testing.
