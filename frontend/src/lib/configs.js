...
export const vehicleConfig = {
  ...
  fields: [
    ...
    { name: "status", label: "Status", type: "select", options: sel(["active", "under_repair", "idle", "sold"]), default: "active" },
...
export const driverConfig = {
  ...
  fields: [
    ...
    { name: "status", label: "Status", type: "select", options: sel(["active", "inactive"]), default: "active" },
